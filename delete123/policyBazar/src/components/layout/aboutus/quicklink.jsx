        ...
        <div className="max-w-screen-xl mx-auto gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="bg-white shadow-lg rounded-lg py-5 px-8 text-center font-subheading ">
              ...
              <p className="text-gray-700 mb-5 font-subheading ">
          ...
          <div className="col-span-2 flex justify-center items-center space-x-8 mt-5 md:mt-10">
            <div className="bg-white shadow-lg rounded-lg py-5 px-5 md:px-32 text-center hover:bg-gradient-to-r from-blue-400 to-green-500 hover:scale-110 transition duration-300 ease-in-out group">
              ...
              <h6 className="text-lg font-subheading font-semibold text-gray-800 mb-2 group-hover:text-white">File A Claim</h6>
            </div>
            <div className="bg-white shadow-lg rounded-lg py-5 px-5 md:px-32 text-center hover:bg-gradient-to-r from-blue-400 to-green-500 hover:scale-110 transition duration-300 ease-in-out group">
              <img src={efficency2} alt="Track Claim" width="45" className="mx-auto mb-3" />
              <h6 className="text-lg font-semibold font-subheading text-gray-800 mb-2 group-hover:text-white">Track Claim</h6>
            </div>
          </div>
        </div>
      </div>
