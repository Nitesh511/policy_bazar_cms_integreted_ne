        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="card shadow-lg bg-gradient-to-r from-blue-400 to-green-500 text-white border-0 h-full p-6">
              <h2 className="text-2xl font-bold mb-4">
                Download Our App Today and Access<br /> Your Insurance Anytime, Anywhere!
              </h2>
              ...
              <div className="flex items-center justify-center md:justify-start ml-32">
                <img src={app1} alt="app 1" className="h-auto md:h-96 max-w-full -mt-40" />
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="card shadow-lg bg-white border-0 h-full p-6">
              <img src={app2} alt="app 2" className="h-60 mx-auto md:mx-0 mb-4" />
              <h3 className="text-xl font-bold mb-2 text-center md:text-left">Get All Features In One Simple App</h3>
