    ...
    <div className="bg-zinc-50 text-center text-surface/75 bg-gradient-to-r from-gray-200 to-green-400 dark:text-white/75 lg:text-left">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
        ...
        <div className="flex justify-center">
          <a href="https://www.facebook.com/profile.php?id=61555884898391" className="me-6 rounded-full bg-blue-900 p-2 hover:bg-blue-600">
          <svg
          ...
          <a href="https://www.policybazaarnepal.com/" className="me-6 rounded-full bg-orange-900 p-2 hover:bg-blue-600">
          <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
              viewBox="0 0 488 512"
          ...
          <a href="https://www.instagram.com/policybazaarnepal/" className="me-6 rounded-full bg-pink-500 p-2 hover:bg-orange-600">
          <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
              viewBox="0 0 448 512"
        ...
        <div className="grid grid-cols-1 gap-0 md:gap-60 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start font-sans">
              ...
              <a href="mailto:info@policybazaarnepal.com">info@policybazaarnepal.com</a>
