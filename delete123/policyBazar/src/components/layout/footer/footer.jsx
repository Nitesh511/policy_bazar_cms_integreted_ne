  ...
  return (
      ...
      <div class="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
        ...
        <div class="flex justify-center">
          <a
            ...
            class="me-6 rounded-full bg-blue-900 p-2 hover:bg-blue-600"
          >
            <svg
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 512 512" class="h-4 w-4">
      <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z" />
          ...
          <a
            href="https://www.policybazaarnepal.com/"
            class="me-6 rounded-full bg-orange-900 p-2 hover:bg-blue-600"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
          ...
          <a
            href="https://www.instagram.com/policybazaarnepal/"
            class="me-6 rounded-full bg-pink-500 p-2 hover:bg-orange-600"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="white"
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 496 512" class="h-4 w-4">
      ...
      <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h6 class="mb-4 flex justify-center font-subheading font-semibold uppercase md:justify-start ml-5">
              Products
            </h6>
          ...
          <div>
            ...
            <p class="mb-4 flex items-center justify-center md:justify-start text-lg">
              ...
              <a href="mailto:info@policybazaarnepal.com">
