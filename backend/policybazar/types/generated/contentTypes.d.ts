...
export interface ApiAboutuAboutu extends Schema.CollectionType {
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bigdesctiption: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiDashboardDashboard extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media<'images'> & Attribute.Required;
    slug: Attribute.UID<'api::dashboard.dashboard', 'title'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPartnerPartner extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media<'images'> & Attribute.Required;
    slug: Attribute.UID<'api::partner.partner', 'title1'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
